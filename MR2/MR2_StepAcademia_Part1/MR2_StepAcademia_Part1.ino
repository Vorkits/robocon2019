...
void setup()
{
  ...
  robot.DelayBalance(FORWARD, spd, percent, 3000);
}
...
void loop()
{
  ...
  if (flag == 1 && robot.CrossCheck())
  {
    ...
    robot.IgnoreCross(11, spd, percent, 100);
    ...
    platform->Stop();
    delay(150);
    robot.IgnoreCross(3, spd, percent, 0);
    robot.AngleTurn(false, spdSlow, 300, 100);   
    robot.DelayBalance(FORWARD, spdSlow, percent, 1000);
    robot.IgnoreCross(1, spd, percent, 0);
    robot.AngleTurn(false, spdSlow, 300, 100);   
    robot.DelayBalance(FORWARD, spdSlow, percent, 1000);
    robot.IgnoreCross(4, spd, percent, 0);
    robot.AngleTurn(false, spdSlow, 300, 100);   
